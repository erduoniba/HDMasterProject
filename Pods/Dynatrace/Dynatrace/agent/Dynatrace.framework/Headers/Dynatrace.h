...
/*!
 ...
 The Dynatrace OneAgent can report on application crashes using the KSCrash framwork. Call this
 method after startupWithApplicationName:serverURL:allowAnyCert:certificatePath: to enable
 crash reporting to the Dynatrace server as well as a Victory server. Crash information will be sent to both systems.
...
/*
 ...
 It ignores any manual startupWithApplicationName calls in your app. serverUrl must start with the transport mechanism
